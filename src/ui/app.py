...
# ============================================================
st.set_page_config(
    page_title="INDOMEX Aprovizionare v06.02 11:15",
    page_icon=None,
    layout="wide",
